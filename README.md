...
不想先讀 Agent、Skill 或資料契約，先開 [案神使用說明書](https://awesome-anson.pages.dev/)。裡面用「客戶說想做網站」的案例，示範案神怎麼把模糊想法整理成可確認的需求、報價、簡報或 Demo，也畫出成交後怎麼交給蓋神。
...
3. 跟 AI 說：**「幫我安裝這個」**（或更明確一點：「讀這個資料夾的 README.md，還有 `.claude/agents/` 底下角色的說明，之後我提到報價、簡報、需求分析，就照這些角色的規則做」）
